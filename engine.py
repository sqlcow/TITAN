...
class trainer():
    def __init__(self, scaler, in_dim, out_dim, num_nodes, nhid, dropout, device, 
                 ...
                 input_len=3,dtw_mx=None,mem_hid=32,
                 layers=3):
        self.model = TITAN(num_nodes, dropout, in_dim=in_dim, out_dim=out_dim, hidden_size=nhid,input_len=input_len,dtw_mx=dtw_mx,mem_hid=mem_hid,layers=layers)
